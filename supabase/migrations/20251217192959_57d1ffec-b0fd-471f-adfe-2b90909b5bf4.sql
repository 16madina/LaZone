-- Create table for legal content
...
-- Everyone can view legal content
CREATE POLICY "Legal content is viewable by everyone"
ON public.legal_content
FOR SELECT
USING (true);

-- Only admins can update legal content
CREATE POLICY "Admins can update legal content"
ON public.legal_content
FOR UPDATE
USING (has_role(auth.uid(), 'admin'::app_role));

-- Only admins can insert legal content
CREATE POLICY "Admins can insert legal content"
ON public.legal_content
FOR INSERT
WITH CHECK (has_role(auth.uid(), 'admin'::app_role));

-- Insert default content with lazoneclient@gmail.com as support email
INSERT INTO public.legal_content (id, title, content) VALUES
('terms', 'Conditions d''utilisation', '# Conditions Générales d''Utilisation de LaZone
...
LaZone ("nous", "notre", "l''Application") est une plateforme numérique de mise en relation entre vendeurs, bailleurs et acheteurs de biens immobiliers en Afrique. LaZone est exploitée par LaZone SAS, société de droit ivoirien.
...
- Email : lazoneclient@gmail.com
- Support : lazoneclient@gmail.com
- Adresse : Abidjan, Côte d''Ivoire'),

('privacy', 'Politique de confidentialité', '# Politique de Confidentialité de LaZone
...
- **Société** : LaZone SAS
- **Adresse** : Abidjan, Côte d''Ivoire
- **Email DPO** : lazoneclient@gmail.com
...
### 6.2 Ce que nous ne faisons pas
...
- **DPO** : lazoneclient@gmail.com
- **Support** : lazoneclient@gmail.com
- **Adresse** : Abidjan, Côte d''Ivoire'),

('community', 'Règles de la communauté', '# Règles de la Communauté LaZone
...
- Contactez-nous à : lazoneclient@gmail.com
...
### 6.2 Appel
Vous pouvez contester une sanction en écrivant à : lazoneclient@gmail.com
...
- Modération : lazoneclient@gmail.com
- Support : lazoneclient@gmail.com'),

('child-safety', 'Sécurité et protection des mineurs', '# Politique de Protection des Mineurs
...
3. Envoyez un email d''urgence à : lazoneclient@gmail.com
...
### 6.2 Technologies de protection
...
### 7.2 Contact LaZone
- Urgences : lazoneclient@gmail.com
- Support général : lazoneclient@gmail.com
...
- **Email prioritaire** : lazoneclient@gmail.com
- **Support** : lazoneclient@gmail.com
